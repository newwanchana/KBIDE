module.exports = function(Blockly){
  'use strict';
Blockly.JavaScript['sw1_is_press'] = function(block) {
...
Blockly.JavaScript['IMU_TurnByAngle_FIX'] = function(block) {
  var dropdown_angle = block.getFieldValue('angle');

  var code = ``;
  if(dropdown_angle == '0'){code += `turnByAngle_fix(90);`}
  if(dropdown_angle == '1'){code += `turnByAngle_fix(-90);`}
  if(dropdown_angle == '2'){code += `turnByAngle_fix(180);`}
  if(dropdown_angle == '3'){code += `turnByAngle_fix(-180);`}
  if(dropdown_angle == '4'){code += `turnByAngle_fix(45);`}
  if(dropdown_angle == '5'){code += `turnByAngle_fix(-45);`}
  return code;
};
