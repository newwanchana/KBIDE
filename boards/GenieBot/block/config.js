...
module.exports = {
    base_blocks : [ // use "blocks : [ " in normally situation but this need to override base block from esp-idf platforms
            ...
            index: 1,
            color : '230',
            icon: `file:///${dirIcon}/static/robot.png`,
            blocks : [
                'sw1_press',
                'sw1_is_press',
                //'sw1_press_one',
            ...
            blocks : [
                ...
                {xml:
                      `<block type="Turn_ultil_check_Sensor">
                            ...
                            <value name="S2">
                                  <block type="Read_Status_Front_Sensor" />
                            </value>
                        </block>`
                },
                {xml:
                      `<block type="move_original_angle">
                ...
                {xml:
                      `<block type="move_PID_until_checkSum">
                ...
                {xml:
                      `<block type="move_PID_until_sensor">
