module.exports = function (Blockly) {
	...
	Blockly.JavaScript['math_map_value'] = function (block) {
		var value_value = Blockly.JavaScript.valueToCode(block, 'VALUE', Blockly.JavaScript.ORDER_ATOMIC);
		var value_fromlow = Blockly.JavaScript.valueToCode(block, 'fromLOW', Blockly.JavaScript.ORDER_ATOMIC);
		var value_fromhigh = Blockly.JavaScript.valueToCode(block, 'fromHIGH', Blockly.JavaScript.ORDER_ATOMIC);
		var value_tolow = Blockly.JavaScript.valueToCode(block, 'toLOW', Blockly.JavaScript.ORDER_ATOMIC);
		var value_tohigh = Blockly.JavaScript.valueToCode(block, 'toHIGH', Blockly.JavaScript.ORDER_ATOMIC);
