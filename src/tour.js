...
เอาหล่ะ! เราจะมาดูรายละเอียดกันในภายหลัง`,
    ...
    },
    {
      //4
      target:
        "#inspire > div.v-dialog__content.v-dialog__content--active > div > div > div.v-card__text > div > div > div",
...
- Programmer Level จะเขียนโปรแกรมด้วยโค้ด</br>`,
    ...
    },
    {
      //5
      target:
        "#inspire > div.v-dialog__content.v-dialog__content--active > div > div > div.v-card__actions > button:nth-child(3)",
    ...
    },
    {
      //6
      target:
        "#inspire > div.v-dialog__content.v-dialog__content--active > div > div.v-card.v-sheet.v-sheet--tile.theme--light",
...
ตัวเลือกนี้คุณสามารถเลือกแปลง block เป็นโค้ด หรือสร้างโค้ดใหม่ได้ เราจะลองสร้างใหม่ดู`,
    ...
    },
    {
      //8
      target:
        "#inspire > div.v-dialog__content.v-dialog__content--active > div > div > div.smooth-scrollbar > div.scroll-content > div > div:nth-child(2) > div > div",
    ...
    },
    {
      //10
      target:
        "#inspire > div.v-dialog__content.v-dialog__content--active > div > div > div.smooth-scrollbar > div.scroll-content > div > div:nth-child(5)",
    ...
    },
    {
      //12
      target:
        "#inspire > div.v-dialog__content.v-dialog__content--active > div > div > div.smooth-scrollbar > div.scroll-content > div",
    ...
    },
    {
      //13
      target:
        "#inspire > div.application--wrap > nav > div > span:nth-child(6)",
