    ...
    >
        ...
        <v-list-tile avatar @click="">
          <v-list-tile-avatar>
            <template v-if="item.category.image">
              <img
                v-if="item.category.image.startsWith('http') === true"
      ...
      <v-expansion-panel popout>
        ...
        >
                  ...
                  <v-btn
                    ...
                    @click="
                      openBlock(
                        example.dir +
                          '/' +
                          example.files.find((obj) => obj.endsWith('.bly'))
                      )
                    "
                  >
                  ...
                  <v-btn
                    ...
                    @click="
                      openCode(
                        example.dir +
                          '/' +
                          example.files.find((obj) => obj.endsWith('.ino'))
                      )
                    "
                  >
          ...
          <v-card>
            <v-card-text
              v-if="example.files.find((obj) => obj.endsWith('.md'))"
            >
